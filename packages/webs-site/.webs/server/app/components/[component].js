...
var Lt = new Map([["--font", ["--font-weight", "--font-size"]], ["--inset", ["--inset-shadow", "--inset-ring"]], ["--text", ["--text-color", "--text-decoration-color", "--text-decoration-thickness", "--text-indent", "--text-shadow", "--text-underline-offset"]]]);
function It(r, t) {
...
var Be = class {
  ...
  keysInNamespaces(t) {
    ...
    for (let e of t) {
      ...
      for (let s of this.values.keys())
        s.startsWith(n) && s.indexOf("--", 2) === -1 && (It(s, e) || i.push(s.slice(n.length)));
    }
    return i;
  }
  get(t) {
  ...
  namespace(t) {
    ...
    for (let [n, s] of this.values)
      n === t ? i.set(null, s.value) : n.startsWith(`${e}-`) ? i.set(n.slice(t.length), s.value) : n.startsWith(e) && i.set(n.slice(e.length), s.value);
    return i;
  }
  addKeyframes(t) {
...
function ee2(r, t, i = null) {
  for (let e = 0;e < r.length; e++) {
    ...
    if (p === 2)
      return 2;
    if (p !== 1 && n.kind === "function" && ee2(n.nodes, t, n) === 2)
      return 2;
  }
}
function Y(r) {
...
`);
  ...
  for (let a = 0;a < r.length; a++) {
    ...
    switch (p) {
      ...
      case fi: {
        let f2 = a;
        for (let u2 = a + 1;u2 < r.length; u2++)
          if (s = r.charCodeAt(u2), s === Ft)
            u2 += 1;
          else if (s === p) {
            a = u2;
            break;
...
function D(r, t, i = [], e = {}) {
  for (let n = 0;n < r.length; n++) {
    ...
    if (s.kind === "context") {
      if (D(s.nodes, t, i, { ...e, ...s.context }) === 2)
        return 2;
      continue;
    }
    i.push(s);
...
var Ai = new Set(["inset", "inherit", "initial", "revert", "unset"]);
var yt = class {
  utilities = new M(() => []);
  completions = new Map;
  static(t, i) {
...
var xt = class {
  ...
  set(t, { kind: i, applyFn: e, compounds: n, compoundsWith: s, order: a }) {
    ...
    p ? Object.assign(p, { kind: i, applyFn: e, compounds: n }) : (a === undefined && (this.lastOrder = this.nextOrder(), a = this.lastOrder), this.variants.set(t, { kind: i, applyFn: e, order: a, compoundsWith: s, compounds: n }));
  }
  nextOrder() {
...
function At(r, t) {
  D(r, (i, { replaceWith: e }) => {
    if (i.kind === "at-rule" && i.name === "@slot")
      ...
      return Object.assign(i, F([z(i.name, i.params, i.nodes)])), 1;
  });
}
...
`,
  ...
  components: breadcrumb_default.components
};
...
// src/app/components/[component].webs
var __component__default = {
  ...
  <div class="w-full p-8 flex flex-col items-start justify-start gap-6">
    ...
    <!-- This will now correctly find and render the registered component -->
