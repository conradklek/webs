...
// webs-components:/Users/conradklek/webs/packages/webs-site/src/gui/menubar.webs
import { provide as provide11, inject as inject11, state as state15 } from "@conradklek/webs";
var MenubarMenu3 = {
  name: "menubar-menu",
  props: { value: { type: String, required: true } },
  setup(props) {
    provide11("menuValue", props.value);
  },
  template(html) {
    return html`<div class="relative"><slot></slot></div>`;
  }
...
var MenubarTrigger3 = {
  name: "menubar-trigger",
  setup() {
    const menubar = inject11("menubar");
    const menuValue = inject11("menuValue");
    return { menubar, menuValue };
  },
  template(html) {
    return html`
...
var MenubarSub3 = {
  ...
  setup() {
    ...
    provide11("submenu", { open, close, is_open });
    return { open, close };
  },
  template(html) {
    return html`<div class="relative" @mouseenter="open" @mouseleave="close">
...
var MenubarSubTrigger3 = {
  name: "menubar-subtrigger",
  setup() {
    const submenu = inject11("submenu");
    return { submenu };
  },
  template(html) {
    return html`
...
var MenubarSeparator3 = {
  name: "menubar-separator",
  template(html) {
    return html`<div class="-mx-1 my-1 h-px bg-muted"></div>`;
  }
};
var MenubarShortcut3 = {
  name: "menubar-shortcut",
  template(html) {
    return html`<span
        class="ml-auto text-xs tracking-widest text-muted-foreground"
...
var menubar_default3 = {
  name: "menubar",
  template: "",
  style: "",
  name: "menubar",
  components: {
    "menubar-menu": MenubarMenu3,
    "menubar-trigger": MenubarTrigger3,
    "menubar-content": MenubarContent3,
    "menubar-item": MenubarItem3,
    "menubar-separator": MenubarSeparator3,
    "menubar-shortcut": MenubarShortcut3,
    "menubar-label": MenubarLabel3,
    "menubar-group": MenubarGroup3,
    "menubar-sub": MenubarSub3,
    "menubar-subtrigger": MenubarSubTrigger3,
    "menubar-subcontent": MenubarSubContent3
  },
  setup() {
    const activeMenu = state15(null);
    function openMenu(value) {
      activeMenu.value = value;
    }
    function closeMenu() {
    ...
    provide11("menubar", { openMenu, closeMenu, toggleMenu, is_open });
  },
  template(html) {
    return html`
        <div
...
export {
  menubar_default3 as default,
  MenubarTrigger3 as MenubarTrigger,
  MenubarSubTrigger3 as MenubarSubTrigger,
  MenubarSubContent3 as MenubarSubContent,
  MenubarSub3 as MenubarSub,
  MenubarShortcut3 as MenubarShortcut,
  MenubarSeparator3 as MenubarSeparator,
  MenubarMenu3 as MenubarMenu,
  MenubarLabel3 as MenubarLabel,
  MenubarItem3 as MenubarItem,
  MenubarGroup3 as MenubarGroup,
  MenubarContent3 as MenubarContent
};
