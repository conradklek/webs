...
// webs-components:/Users/conradklek/webs/packages/webs-site/src/gui/user-navbar.webs
import { session as session3, route as route2 } from "@conradklek/webs";
var user_navbar_default2 = {
  name: "user-navbar",
  template: `<div class="flex-1">
    <div class="w-full flex flex-row items-center justify-end gap-4">
      {#if !session.isLoggedIn}
  ...
  setup(props) {
    ...
    return { session: session3, route: route2, handleLogout, params: props.params };
  }
};
export {
  user_navbar_default2 as default
};
