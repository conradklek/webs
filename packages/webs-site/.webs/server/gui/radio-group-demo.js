...
// webs-components:/Users/conradklek/webs/packages/webs-site/src/gui/radio-group.webs
...
var RadioGroupItem3 = {
  ...
  setup(props) {
    const radioGroup = inject11("radioGroup");
    return { radioGroup, value: props.value };
  },
  template(html) {
    return html`
...
var radio_group_default3 = {
  name: "radio-group",
  template: "",
  style: "",
  name: "radio-group",
  components: { "radio-group-item": RadioGroupItem3 },
  props: {
    defaultValue: { type: String }
  },
  setup(props) {
    const selectedValue = state15(props.defaultValue);
    function select(value) {
      selectedValue.value = value;
    }
    function is_selected(value) {
    ...
    provide11("radioGroup", { select, is_selected });
  },
  template(html) {
    return html`
        <div role="radiogroup" class="flex flex-col gap-2">
...
// webs-components:/Users/conradklek/webs/packages/webs-site/src/gui/radio-group-demo.webs
var radio_group_demo_default2 = {
  name: "radio-group-demo",
  template: `<radio-group defaultValue="comfortable">
    <div class="flex items-center space-x-2">
      <radio-group-item value="default" id="r1" />
  ...
  components: {
    ...registry_default,
    "radio-group": radio_group_default3,
    ...radio_group_default3.components
  }
};
export {
  radio_group_demo_default2 as default
};
