...
// webs-components:/Users/conradklek/webs/packages/webs-site/src/gui/modal.webs
import { provide as provide11, inject as inject11, state as state15 } from "@conradklek/webs";
var ModalTrigger3 = {
  name: "modal-trigger",
  setup() {
    const modal = inject11("modal");
    return { modal };
  },
  template(html) {
    return html`<button type="button" @click="modal.open()">
...
var modal_default3 = {
  ...
  name: "modal",
  components: {
    "modal-trigger": ModalTrigger3,
    "modal-content": ModalContent3,
    "modal-header": ModalHeader3,
    "modal-footer": ModalFooter3,
    "modal-title": ModalTitle3,
    "modal-description": ModalDescription3,
    "modal-close": ModalClose3
  },
  setup() {
    const opened = state15(false);
    function open() {
      opened.value = true;
    }
    function close() {
    ...
    provide11("modal", { open, close, isOpen });
  },
  template(html) {
    return html`<div><slot></slot></div>`;
  }
...
export {
  modal_default3 as default,
  ModalTrigger3 as ModalTrigger,
  ModalTitle3 as ModalTitle,
  ModalHeader3 as ModalHeader,
  ModalFooter3 as ModalFooter,
  ModalDescription3 as ModalDescription,
  ModalContent3 as ModalContent,
