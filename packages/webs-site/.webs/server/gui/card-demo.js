...
// webs-components:/Users/conradklek/webs/packages/webs-site/src/gui/card.webs
var CardContent3 = {
  name: "card-content",
  template(html) {
    return html`
...
var card_default3 = {
  ...
  name: "card",
  components: {
    "card-header": CardHeader3,
    "card-title": CardTitle3,
    "card-description": CardDescription3,
    "card-content": CardContent3,
    "card-footer": CardFooter3
  },
  template(html) {
    return html`
        <div
...
// webs-components:/Users/conradklek/webs/packages/webs-site/src/gui/card-demo.webs
var card_demo_default2 = {
  name: "card-demo",
  template: `<card class="w-[350px]">
    <card-header>
      <card-title>Create project</card-title>
  ...
  components: {
    ...registry_default,
    card: card_default3,
    ...card_default3.components
  }
};
export {
  card_demo_default2 as default
};
