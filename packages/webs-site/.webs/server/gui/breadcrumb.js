...
// webs-components:/Users/conradklek/webs/packages/webs-site/src/gui/breadcrumb.webs
var BreadcrumbList3 = {
  template(html) {
    return html`
        <ol class="flex flex-wrap items-center gap-1.5 break-words sm:gap-2.5">
...
var breadcrumb_default3 = {
  name: "breadcrumb",
  template: "",
  style: "",
  components: {
    "breadcrumb-list": BreadcrumbList3,
    "breadcrumb-item": BreadcrumbItem3,
    "breadcrumb-link": BreadcrumbLink3,
    "breadcrumb-active": BreadcrumbActive3,
    "breadcrumb-separator": BreadcrumbSeparator3,
    "breadcrumb-ellipsis": BreadcrumbEllipsis3
  },
  template(html) {
    return html`<nav aria-label="breadcrumb">
        <slot></slot>
...
export {
  breadcrumb_default3 as default,
  BreadcrumbSeparator3 as BreadcrumbSeparator,
  BreadcrumbList3 as BreadcrumbList,
  BreadcrumbLink3 as BreadcrumbLink,
  BreadcrumbItem3 as BreadcrumbItem,
  BreadcrumbEllipsis3 as BreadcrumbEllipsis,
  BreadcrumbActive3 as BreadcrumbActive
};
