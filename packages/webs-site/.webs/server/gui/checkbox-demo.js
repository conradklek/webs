...
// webs-components:/Users/conradklek/webs/packages/webs-site/src/gui/checkbox.webs
import { state as state15 } from "@conradklek/webs";
var checkbox_default3 = {
  name: "checkbox",
  template: "",
  style: "",
  name: "checkbox",
  ...
  setup(props) {
    const isChecked = state15(props.defaultChecked);
    function toggle() {
      isChecked.value = !isChecked.value;
    }
    return {
...
// webs-components:/Users/conradklek/webs/packages/webs-site/src/gui/checkbox-demo.webs
var checkbox_demo_default2 = {
  name: "checkbox-demo",
  template: `<div class="flex items-center space-x-2">
    <checkbox id="terms" />
    <label
  ...
  components: {
    ...registry_default,
    checkbox: checkbox_default3
  }
};
export {
  checkbox_demo_default2 as default
};
