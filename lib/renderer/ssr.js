 ...
 * @param {import('../core/vdom.js').VNode} vnode The root VNode to render.
 ...
 * @param {{componentState: object}} context
  ...
  switch (type) {
    ...
    case Teleport:
      if (
        ...
        const slots = /** @type {import('../core/vdom.js').Slots} */ (children);
        if (slots.default) {
      ...
      return await renderChildren(
        /** @type {VNodeChildren | import('../core/vdom.js').Slots} */ (
          children
        ),
        parentComponent,
        context,
...
/**
 * @internal
 * @param {VNodeChildren | import('../core/vdom.js').Slots} children
 * @param {ComponentInstance | null} parentComponent
 * @param {{componentState: object}} context
 * @returns {Promise<string>}
 */
