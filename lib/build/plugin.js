 ...
 * @property {string} registryPath - Path to the global component registry.
 * @property {string} guiDir - Path to the global UI components directory.
 */

/**
 * Custom Bun plugin to handle .webs single-file components.
 * This is a direct port of the logic from the stable `plugin-old.js`.
