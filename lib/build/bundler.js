 ...
 * @param {Array<{name: string, path: string}>} layoutWrapperEntrypoints - Array of layout wrapper objects.
 * @param {{version: number, clientTables: any[]}} dbConfig - The database configuration.
 * @param {import('../server/server-config.js').Config} config - The global server configuration.
 ...
 * @param {{version: number, clientTables: any[]}} dbConfig - The database configuration.
 * @param {import('../server/server-config.js').Config} config - The global server configuration.
 * @returns {Promise<import('bun').BuildOutput['outputs'] | null>} The build outputs or null if failed.
 */
 ...
 * @param {import('bun').BuildOutput['outputs']} buildOutputs - The outputs from the client bundle build.
 * @param {import('../server/server-config.js').Config} config - The global server configuration.
