...
describe('Webs C Core Array', () => {
  ...
  // CHANGE: The test for chaining push calls has been removed as the new API
  // returns a status code and does not support chaining. The functionality is
  // covered by the updated tests above.
});
