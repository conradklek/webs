 ...
 * @param {Record<string, import('../lib/server/router.js').RouteDefinition>} inspectionData.appRoutes
 * @param {Record<string, import('../lib/server/ai.server.js').AgentDefinition>} inspectionData.agentRoutes
 * @param {string[]} inspectionData.sourceEntrypoints
 * @param {import('../lib/server/server-config.js').Config} inspectionData.config
